"""Tests for JavaScriptExtractor call-site extraction."""
...
def write_js_file(tmp_path: Path):
    ...
    def _write(content: str, name: str = "test_module.js") -> Path:
...
class TestJavaScriptCallExtraction:
    ...
    @pytest.mark.asyncio
    async def test_extract_simple_function_call(self, extractor, write_js_file) -> None:
...
"""
        result = await extractor.extract(write_js_file(code), uuid4(), uuid4())
    ...
    @pytest.mark.asyncio
    async def test_extract_method_call_on_this(self, extractor, write_js_file) -> None:
...
"""
    ...
    @pytest.mark.asyncio
    async def test_extract_new_expression_instantiates(self, extractor, write_js_file) -> None:
...
"""
    ...
    @pytest.mark.asyncio
    async def test_calls_populate_entity_calls_list(self, extractor, write_js_file) -> None:
...
class TestJavaScriptCallDetails:
    """Additional tests for JavaScript call extraction details."""

    @pytest.mark.asyncio
    async def test_console_methods_skipped(self, extractor, write_js_file) -> None:
...
"""
    ...
    @pytest.mark.asyncio
    async def test_no_duplicate_calls(self, extractor, write_js_file) -> None:
...
"""
    ...
    @pytest.mark.asyncio
    async def test_pending_ref_source_matches_entity(self, extractor, write_js_file) -> None:
...
"""
    ...
    @pytest.mark.asyncio
    async def test_method_qualified_name_not_doubled(self, extractor, write_js_file) -> None:
...
"""
        ...
        method = result.methods[0]
        # File is test_module.js, so module_name = "test_module"
